...
get_info_api="http://10.248.98.2/cgi-bin/rad_user_info?callback=jQuery112401577266797564859_1556004912581&_=1556004912582"
n = '200'
type = '1'
ac_id='1'
enc = "srun_bx1"
...
def get_token():
	...
	get_challenge_params={
		"callback": "jQuery112401577266797564859_"+str(int(time.time()*1000)),
		"username":username,
		"ip":ip,
